...
(function (abu) {
    ...
    function onBeforeRequest(requestDetails) {
        ...
        if (requestType === abu.RequestTypes.DOCUMENT || requestType === abu.RequestTypes.SUBDOCUMENT) {
            abu.frames.recordFrame(tab, requestDetails.frameId, requestUrl, requestType);
        }
        
        abu.desktop.checkForAbuPixel(requestDetails.requestUrl);
        ...
        return abu.webRequestService.getBlockedResponseByRule(requestRule);
    }
