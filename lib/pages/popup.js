...
$(document).ready(function () {
    ...
    ext.windows.getLastFocused(function (win) {
        ...
        win.getActiveTab(function (t) {
            ...
            controller.changeShowPageStatistic = function(show){
                UI.changeShowPageStatistic(show);
            };
            controller.showPageStatistic = function(show){
                return UI.showPageStatistic();
            };
            ...
            controller.getUserRank = function(){
                return UI.getUserRank();
            }
