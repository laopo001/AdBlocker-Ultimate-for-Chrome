...
var PageStatistic = exports.PageStatistic = function () {
	...
	var contributePage = 'https://adblockultimate.com/donate.html';
	...
	this.getUserRank = function(){
	  	...
	  	userRanks[1]['buttonUrl'] = ratePages[browser];
	  	userRanks[2]['buttonUrl'] = ratePages[browser];
	  	if(browser == 'Safari'){
			...
			if(this.didUserRate() > 0){
		    	...
		    	userRanks[rankN]['buttonUrl'] = ratePages[browser];
